...
function nebulaone_embed_menu() {
    // Adds a new menu item under "Settings" for the nebulaONE AI Embed settings page.
    add_options_page(
        'nebulaONE AI Embed Settings',       // The text to be displayed in the title tags of the page when the menu is selected.
        'nebulaONE AI Embed',                // The text to be used for the menu.
...
function nebulaone_embed_settings_page() {
    ...
    ?>
    <div class="wrap">
        <h1>nebulaONE AI Embed Settings</h1>
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row">Host Name <span class="nebulaone-help" data-help="Enter the full URL of the nebulaONE AI host, including https://.">?</span></th>
                ...
                <tr valign="top">
                    <th scope="row">GPT System <span class="nebulaone-help" data-help="Specify the GPT system endpoint configured under the Publish GPT Section.">?</span></th>
...
function nebulaone_embed_admin_notice() {
    if (get_option('nebulaone_terms_accepted') !== 'yes') {
        ...
        <div class="notice notice-warning is-dismissible">
            <p><?php _e('Please read and accept the <a href="#" id="nebulaone-terms-link">Terms and Conditions</a> to use the nebulaONE AI Embed Plugin.', 'nebulaone-embed'); ?></p>
            <p>
